 ...
 */
#define STEPPER_SPEED_ULTRA_FAST    800     /**< Ultra fast mode: 800μs/step (0.8ms) */
#define STEPPER_SPEED_FAST          1000    /**< Fast mode: 1000μs/step (1ms) */
...
#define STEPPER_START_DELAY_US      2500    /**< Start delay (slower, ensures smooth start with enough torque) */
#define STEPPER_ACCEL_STEPS         40      /**< Acceleration steps (more steps for smoother transition) */
#define STEPPER_DECEL_STEPS         40      /**< Deceleration steps */
