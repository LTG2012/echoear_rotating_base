...
#define CMD_BASE_ANGLE_QUERY        (0x04)          /**< Base angle query */
#define CMD_BASE_ANGLE_RESPONSE     (0x04)          /**< Base angle response */

/* ========== Magnetic Switch Special Command Codes ========== */
#define MAG_SWITCH_CMD_RECALIBRATE  (0x0010)        /**< Recalibrate magnetic switch */
#define MAG_SWITCH_CALIB_START      (0x0010)        /**< Start calibration (matches ECHO_BASE_CMD_RECV_CALIBRATE_START) */
#define MAG_SWITCH_CALIB_FIRST_DONE (0x0011)        /**< First position done (matches ECHO_BASE_CMD_RECV_CALIBRATE_STEP1) */
#define MAG_SWITCH_CALIB_SECOND_DONE (0x0012)       /**< Second position done (matches ECHO_BASE_CMD_RECV_CALIBRATE_STEP2) */
 ...
 * 
 * @param angle Current angle in degrees (0-360, 0 = home position)
 * @return esp_err_t ESP_OK indicates success
 * 
 * Packet format:
 ...
 * [5-6]: Angle data (big-endian, integer part of angle * 10 for 0.1 degree precision)
 * [7]:   Checksum (command code + data bytes sum)
 */
